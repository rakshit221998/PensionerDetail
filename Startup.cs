...
using PensionerDetailApi.Services;
...
namespace PensionerDetailApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPensionerRepository, PensionerRepository>(); // Difference between AddTransient, AddScoped, AddSingleton
            services.AddScoped<IPensionerService, PensionerService>();
